...
class CoachRewievAdmin: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @objc func addTapped(){
        ...
        let submitAction = UIAlertAction(title: "OK", style: UIAlertAction.Style.default) {
            ...
            if self.checkValue(username: usernameTxField.text!,firstName: firstNameTxField.text!, lastName: lastNameTxField.text!, password: passwordTxField.text!, email: emailTxField.text!){
    ...
    func checkValue(username: String, firstName : String, lastName : String, password : String, email : String) -> Bool {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let submitAction = UIAlertAction(title: "Submit", style: UIAlertAction.Style.default) {
            ...
            if self.checkValue(username: usernameTxField.text!, firstName: firstNameTxField.text!, lastName: lastNameTxField.text!, password: passwordTxField.text!, email: emailTextField.text!){
